...
export const PinkWave = () => {
  return (
    <div className="relative w-full overflow-hidden leading-[0] bg-black">
      ...
      >
        <defs>
          <linearGradient id="pink-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#db2777" /> {/* Dark Pink */}
            <stop offset="50%" stopColor="#ec4899" /> {/* Medium Pink */}
        ...
        <path
          ...
          opacity="0.3"
          className="animate-wave-move-slower"
        />
